...
>(({ className, ...props }, ref) => (
  <th
    ref={ref}
    className={cn(
      "w-20 md:w-auto h-12 md:px-4 text-left align-middle font-medium text-neutral-500 [&:has([role=checkbox])]:pr-0 dark:text-neutral-400",
      className
    )}
    {...props}
  />
...
>(({ className, ...props }, ref) => (
  <td
    ref={ref}
    className={cn("p-1.5 md:p-4 align-middle [&:has([role=checkbox])]:pr-0", className)}
    {...props}
  />
))
